...
<body>
    ...
    <aside class="sidebar" id="adminSidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <?php $hasMarketing = $can('marketing_videos') || $can('marketing_articles') || $can('marketing_faqs') || $can('marketing_topics') || $can('marketing_needs') || $can('marketing_home') || $can('marketing_routines') || $can('marketing_quizzes'); if ($hasMarketing): ?><div class="nav-section">Contenido y Marketing</div><?php endif; ?>
