...
<div class="page">
  <h2 style="margin:0 0 10px">Demo tecnica: horarios / cupos / sede</h2>
  <p style="margin:0;color:rgba(246,244,239,0.72)">Cargar solo lunes. No se permiten fechas pasadas.</p>
  <div style="margin-top:10px">
    <a class="btn secondary" href="/admin/demo-tecnica">Volver a registros</a>
  </div>
</div>

<div class="page" style="margin-top:14px">
  <h3 style="margin:0 0 10px">Nuevo horario</h3>
  <form method="post" action="/admin/demo-tecnica/horarios/save">
    ...
    <tbody>
      <?php foreach ($events as $ev): ?>
        <tr>
          ...
          <td style="padding:10px;border-bottom:1px solid rgba(255,255,255,0.07)">
            <form method="post" action="/admin/demo-tecnica/horarios/save" style="display:grid;grid-template-columns:140px 88px 88px 80px 1fr 120px auto;gap:8px;align-items:center">
              <input type="hidden" name="_csrf" value="<?= htmlspecialchars($csrf) ?>" />
