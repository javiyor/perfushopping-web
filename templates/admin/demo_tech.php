...
<div class="page">
  <h2 style="margin:0 0 10px">Demo tecnica (registros)</h2>
  <p style="margin:0;color:rgba(246,244,239,0.72)">Registros para eventos de demostracion tecnica (solo lunes).</p>
  <div style="margin-top:10px">
    <a class="btn secondary" href="/admin/demo-tecnica/horarios">Horarios / cupos / sede</a>
  </div>
</div>
    ...
    <tbody>
      <?php foreach ($list as $r): ?>
        <tr>
          ...
          <td style="padding:10px;border-bottom:1px solid rgba(255,255,255,0.07)">
            <form method="post" action="/admin/demo-tecnica/status" style="display:flex;gap:8px;align-items:center">
