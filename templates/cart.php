...
<div class="page two">
      ...
      <?php foreach ($items as $it): ?>
        ...
        <div class="cartline" style="margin-bottom:12px">
          <div>
            ...
            <div class="meta">Unitario (sin IVA): <?= htmlspecialchars(Format::moneyFromCents((int)$it['unit_net_cents'])) ?></div>
          </div>
          <div class="right">
            <div style="font-weight:800"><?= htmlspecialchars(Format::moneyFromCents((int)$it['line_total_cents'])) ?></div>
  ...
  <div>
    ...
    <div class="notice">
      <div class="row"><span class="grow">Subtotal (sin IVA)</span><strong><?= htmlspecialchars(Format::moneyFromCents((int)$subtotalNet)) ?></strong></div>
      <div class="row" style="margin-top:6px"><span class="grow">IVA</span><strong><?= htmlspecialchars(Format::moneyFromCents((int)$iva)) ?></strong></div>
      <div class="row" style="margin-top:10px"><span class="grow" style="font-weight:800">Total</span><strong style="font-size:18px"><?= htmlspecialchars(Format::moneyFromCents((int)$total)) ?></strong></div>
    </div>

    <div class="notice" style="margin-top:12px">
      Minimo: <strong>$40.000</strong> (con descuento aplicado). Envio gratis desde <strong>$200.000</strong>.
    </div>

    <?php if ($items && !$isWholesale && $inst): ?>
      <div class="notice" style="margin-top:12px">
        <strong><?= htmlspecialchars((string)($inst['promo']['descrip'] ?? 'Cuotas')) ?>:</strong>
        <?= (int)$inst['cuotas'] ?>x <strong><?= htmlspecialchars(Format::moneyFromCents((int)$inst['cuota_cents'])) ?></strong>
