...
final class AdminAuthService
{
    private static array $permisosPorRol = [
        'superadmin' => ['*'],
        'ventas' => ['productos', 'clientes', 'facturacion', 'presupuestos', 'remitos', 'recibos', 'cta_cte', 'marketing_videos', 'marketing_articles', 'marketing_faqs', 'marketing_topics', 'marketing_needs', 'marketing_home', 'product_commercial_edit'],
